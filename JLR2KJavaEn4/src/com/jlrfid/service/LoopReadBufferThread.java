...
public class LoopReadBufferThread implements Runnable{
	 ...
	 */
	public LoopReadBufferThread(MainDllLib lib, CallbackFunctionImpl FUN_CMC){
		this.lib = lib;
		this.FUN_CMC = FUN_CMC;
	}

	public void run() {
		int result = lib.ReadTagBuffer(FUN_CMC);
